#!/bin/bash
#
# Test SageMaker endpoint for crypto price prediction
# Usage: ./scripts/test_sagemaker_endpoint.sh
#
...
OUTPUT_FILE="/tmp/sagemaker_response.json"
INPUT_FILE="/tmp/sagemaker_request.json"
...
# These are example values - in production, you'd compute actual technical indicators
cat > "$INPUT_FILE" << 'EOF'
{
  "instances": [
    {
      ...
      "close": 67650.0,
      "volume": 1250.5,
      "price_change_1": 0.002,
      "price_change_5": 0.008,
      "price_change_15": 0.015,
      "price_change_30": 0.025,
      "sma_5": 67400.0,
      "sma_10": 67200.0,
      "sma_20": 67000.0,
      "sma_50": 66500.0,
      ...
      "ema_10": 67250.0,
      "ema_20": 67050.0,
      "price_sma_5_ratio": 1.0037,
      "price_sma_20_ratio": 1.0097,
      "price_ema_10_ratio": 1.0059,
      "volatility_10": 250.0,
      "volatility_20": 300.0,
      "price_range": 0.0089,
      "volume_sma_10": 1100.0,
      "volume_ratio": 1.137,
      "volume_change": 0.15,
      "vwap": 67300.0,
      "price_vwap_ratio": 1.0052,
      "rsi_14": 55.0,
      "rsi_7": 58.0,
      "macd": 150.0,
      "macd_signal": 120.0,
      ...
      "dow_sin": 0.782,
      "dow_cos": -0.623,
      "support_level": 66800.0,
      "resistance_level": 68200.0,
      "support_distance": 0.0126,
      "resistance_distance": 0.0081,
      "bid_ask_spread": 600.0,
      "spread_ratio": 0.0089
    }
  ]
}
